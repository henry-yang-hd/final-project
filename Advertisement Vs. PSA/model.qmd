...
**• Income:** For every additional $10,000 of income, the log-odds of purchasing the product increases by 0.0108, with a confidence interval of -0.00762 to 0.0293. This interval barely includes zero, but it is still not statistically significant. So, income does not have a clear effect on the probability of purchasing the product.
...
$$\widehat{\text{logit}(P(\text{Conversion} = 1))} = -1.25 + 0.143 \cdot \text{CampaignChannel}_{\text{PPC}} + 0.151 \cdot \text{CampaignChannel}_{\text{Referral}} + 0.0915 \cdot \text{CampaignChannel}_{\text{SEO}} - 0.00165 \cdot \text{CampaignChannel}_{\text{Social Media}} + 0.00133 \cdot \text{Age} + 0.0134 \cdot \text{Gender}_{\text{Male}} + 0.0108 \cdot \text{Income}_{10k} + 0.0146 \cdot \text{AdSpend}_{100} + 0.0185 \cdot \text{WebsiteVisits} + 0.131 \cdot \text{PagesPerVisit} + 0.100 \cdot \text{TimeOnSite} - 0.00101 \cdot \text{SocialShares} + 0.128 \cdot \text{PreviousPurchases}$$
