...
plot_predictions(extract_fit_engine(fit_campaign), condition = c("CampaignChannel"), draw = FALSE) |> 
  ...
  labs(
    ...
    subtitle = "Conversion rates range from ~70% to ~77% with minor differences between channels",
    y = "Percentage",
    x = "Campaign Channel",
...
plot_predictions(
  ...
  labs(
    ...
    subtitle = "Income levels have subtle impact on conversion probability, but more impact than age",
    x = "Income ($10,000s)",
    y = "Conversion Percentage",
    caption = "Source: Digital Marketing Campaign Dataset",
    color = "Campaign Channel",
